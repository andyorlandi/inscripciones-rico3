// ⚠️⚠️⚠️ PELIGRO ⚠️⚠️⚠️
// Este script BORRA TODOS los datos de la base de datos.
// NUNCA ejecutar si DATABASE_URL apunta a producción.
// Usar solo para testing con confirmación explícita.
// ⚠️⚠️⚠️ PELIGRO ⚠️⚠️⚠️
